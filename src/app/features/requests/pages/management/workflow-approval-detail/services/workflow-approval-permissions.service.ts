...
export class WorkflowApprovalPermissionsService {
  ...
  private readonly VIEW_WORKFLOW_SUPPLY_SUMMARY_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.VIEW_WORKFLOW_SUPPLY_SUMMARY;
  private readonly SUBMIT_SUPPLY_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.SUBMIT_SUPPLY;
  private readonly REVIEW_WEAPON_SUPPLY_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.REVIEW_WEAPON_SUPPLY;
  private readonly SELECT_DEPOTS_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.SELECT_DEPOTS;
  private readonly UPDATE_REQUEST_ITEMS_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.UPDATE_REQUEST_ITEMS;
  private readonly SET_RETURN_DEPOT_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.SET_RETURN_DEPOT;
  private readonly SET_RETURN_DELIVERY_DATE_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.SET_RETURN_DELIVERY_DATE;
  private readonly PROCESS_RETURN_ITEMS_PERMISSION = PERMISSIONS.REQUESTS.WORKFLOW_APPROVAL.PROCESS_RETURN_ITEMS;
