...
/** @see `ettadbackend/Ettad.RequestManagement.Service/Common/Dtos/RequestItemWeaponAssociationDto.cs` */
export interface RequestManagementRequestItemWeaponAssociationDto {
  id: number;
