...
export const ASSET_LIST_EXPORT_PERMISSIONS: Record<AssetType, readonly string[]> = {
  ...
  accessory: [
    PERMISSIONS.ASSETS.ACCESSORY.PAGE,
    PERMISSIONS.ASSETS.ACCESSORY.VIEW,
    PERMISSIONS.ASSETS.ACCESSORY.CREATE_CLAIM,
    PERMISSIONS.ASSETS.ACCESSORY.EDIT
  ]
};
...
export const ASSET_LIST_CREATE_PERMISSIONS: Record<AssetType, readonly string[]> = {
  ...
  accessory: [PERMISSIONS.ASSETS.ACCESSORY.CREATE_CLAIM]
};
